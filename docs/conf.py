...
latex_documents = [
    (master_doc, "python_example.tex", "python_example Documentation", "Sylvain Corlay", "manual"),
]
...
man_pages = [(master_doc, "python_example", "python_example Documentation", [author], 1)]
